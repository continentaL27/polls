...
import com.conti.polls.model.ChoiceVoteCount;
import com.conti.polls.model.Vote;
...
public interface VoteRepository extends JpaRepository<Vote, Long> {
    ...
    @Query("SELECT NEW com.conti.polls.model.ChoiceVoteCount(v.choice.id, count(v.id))" +
